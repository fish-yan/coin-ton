...
function storeOutListExtendedV5R1(actions) {
    ...
    return (builder) => {
        const outListPacked = basicActions.length ? (0, ton_core_1.beginCell)().store((0, ton_core_1.storeOutList)(basicActions.slice().reverse())) : null;
...
function loadOutListExtendedV5R1(slice) {
    ...
    if (outListPacked) {
        const loadedActions = (0, ton_core_1.loadOutList)(outListPacked.beginParse());
...
function toSafeV5R1SendMode(sendMode, authType) {
    ...
    return sendMode | ton_core_1.SendMode.IGNORE_ERRORS;
}
...
//# sourceMappingURL=WalletV5R1Actions.js.map