...
class VenomWalletV3 {
    ...
    constructor(workchain, publicKey, walletId) {
        ...
        let code = ton_core_1.Cell.fromBoc(Buffer.from('te6ccgEBAQEAcQAA3v8AIN0gggFMl7ohggEznLqxn3Gw7UTQ0x/THzHXC//jBOCk8mCDCNcYINMf0x/TH/gjE7vyY+1E0NMf0x/T/9FRMrryoVFEuvKiBPkBVBBV+RDyo/gAkyDXSpbTB9QC+wDo0QGkyMsfyx/L/8ntVA==', 'base64'))[0];
    ...
    createWalletTransferV3Venom(args) {
        ...
        let signature = crypto_lib_1.signUtil.ed25519.sign(signHash, args.secretKey);
        return (0, ton_core_1.beginCell)()
...
exports.VenomWalletV3 = VenomWalletV3;
//# sourceMappingURL=VenomWalletV3.js.map